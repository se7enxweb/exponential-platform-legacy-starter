...
# It prepares the various PARAM_EZ_MYSQL_* parameters for Exponential scripts
...
# It prepares the various PARAM_EZ_POSTGRESQL_* parameters for Exponential scripts
