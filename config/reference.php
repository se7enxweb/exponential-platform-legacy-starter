 ...
 *         },
 *         ezpublish_legacy_sso?: array<mixed>,
 *         login_link?: array{
 ...
 *             },
 *             ezxml?: array{
 *                 custom_tags?: list<array{ // Default: []
 *                     path?: scalar|Param|null, // Path of the XSL stylesheet to load.
 *                     priority?: int|Param, // Priority in the loading order. A high value will have higher precedence in overriding XSL templates. // Default: 0
 *                 }>,
 *             },
 *         },
 ...
 *     }>,
 * }
 * @psalm-type NetgenSiteLegacyConfig = array{
 *     system?: array<string, array{ // Default: []
 *         injected_settings?: list<list<mixed>>,
 *         injected_merge_settings?: list<list<list<scalar|Param|null>>>,
 *     }>,
 * }
 * @psalm-type EzPublishLegacyConfig = array{
 *     enabled?: bool|Param, // Default: true
 *     clear_all_spi_cache_on_symfony_clear_cache?: bool|Param, // Default: true
 *     clear_all_spi_cache_from_legacy?: bool|Param, // Default: true
 *     root_dir?: scalar|Param|null,
 *     legacy_aware_routes?: list<scalar|Param|null>,
 *     system?: array<string, array{ // Default: []
 *         templating?: array{
 *             view_layout?: scalar|Param|null, // Template reference to use as pagelayout while rendering a content view in legacy
 *             module_layout?: scalar|Param|null, // Template reference to use as pagelayout for legacy modules. If not specified, pagelayout from legacy will be used.
 *         },
 *         legacy_mode?: bool|Param, // Whether to use legacy mode or not. If true, will let the legacy kernel handle url aliases.
 *     }>,
 * }
 ...
 *     ngsite?: NgsiteConfig,
 *     netgen_site_legacy?: NetgenSiteLegacyConfig,
 *     ez_publish_legacy?: EzPublishLegacyConfig,
 *     "when@behat"?: array{
 *         imports?: ImportsConfig,
 *         parameters?: ParametersConfig,
 *         services?: ServicesConfig,
