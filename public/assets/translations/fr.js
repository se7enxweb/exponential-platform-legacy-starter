(function (t) {
// fr
t.add("field_definition.tags.validator.subtree_limit", "Limiter par sous-arbre de tag", "ibexa_content_type", "fr");
t.add("field_definition.tags.validator.subtree_limit.no_limit", "Aucune limite de sous-arbres", "ibexa_content_type", "fr");
t.add("field_definition.tags.validator.max_tags", "Nombre maximum de tags autoris\u00e9es", "ibexa_content_type", "fr");
t.add("field_definition.tags.validator.max_tags.no_limit", "Aucune limite", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.edit_view", "Modifier la vue", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.edit_view.default", "Vue par d\u00e9faut", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.edit_view.select", "S\u00e9lectionner la vue", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.edit_view.tree", "Vue de l'arbre", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.hide_root_tag", "Masquer le tag de limite de sous-arbre racine lors de l'\u00e9dition de l'objet", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.yes", "Oui", "ibexa_content_type", "fr");
t.add("field_definition.tags.settings.no", "Non", "ibexa_content_type", "fr");
...
t.add("max_file_size.message", "%contentTypeName% taille de fichier max: %maxFileSize%", "ibexa_multi_file_upload", "fr");
...
t.add("multi_file_upload_popup.subtitle", "Under %name%", "ibexa_multi_file_upload", "fr");
t.add("multierror.label", "\u00c9chec du chargement ", "ibexa_multi_file_upload", "fr");
...
t.add("upload_popup.cancel_label", "Cancel pending upload", "ibexa_multi_file_upload", "fr");
t.add("upload_popup.close_label", "Close", "ibexa_multi_file_upload", "fr");
t.add("upload_popup.confirm_label", "Confirm and close", "ibexa_multi_file_upload", "fr");
t.add("upload_popup.label", "Upload", "ibexa_multi_file_upload", "fr");
t.add("upload_popup.title", "Multi-file upload", "ibexa_multi_file_upload", "fr");
...
t.add("notification.mark_as_unread", "Marquer comme non-lu", "ibexa_notifications", "fr");
...
t.add("notification.read", "Lu", "ibexa_notifications", "fr");
t.add("notification.status", "Statut", "ibexa_notifications", "fr");
t.add("notification.status.read", "Lu", "ibexa_notifications", "fr");
t.add("notification.status.unread", "Non lus", "ibexa_notifications", "fr");
t.add("notification.title", "Titre\u00a0:", "ibexa_notifications", "fr");
t.add("notification.trashed", "Envoy\u00e9 \u00e0 la Corbeille", "ibexa_notifications", "fr");
t.add("notification.trashed.info", "d\u00e9plac\u00e9 vers la corbeille", "ibexa_notifications", "fr");
t.add("notification.unread", "Non lus", "ibexa_notifications", "fr");
